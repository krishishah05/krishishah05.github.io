...
function makeMediaItem(item, idx, set) {
  ...
  if (item.type === 'video') {
    ...
    div.innerHTML = `<div style="display:flex;align-items:center;justify-content:center;height:100%;${bg}"><div style="background:rgba(0,0,0,0.5);border-radius:50%;width:44px;height:44px;display:flex;align-items:center;justify-content:center;"><i class="fas fa-play" style="font-size:1rem;color:#fff;margin-left:3px;"></i></div></div>`;
  } else {
