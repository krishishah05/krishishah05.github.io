...
Personal portfolio website for Krishi Shah — SWE Intern @ Airbnb, CS Honors Scholar @ NJIT, singer, traveler, leader.
...
The `js/drive-config.js` file is not tracked in git — add it locally after cloning.
